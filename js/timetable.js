...
if (typeof global === 'undefined' || typeof global.it !== 'function') {
    $(function () {
        ...
        $.get('./data/timetable.json?VERSION=' + revisionNum, {}, function (data) {
            ...
            Calendar.updateView();
            Calendar.shiftWeek(-43); // This is a stupid hack to get the correct week to display before the current week gets changed. Please remove this if you find a work around!
